...
class Config:
    ...
    SUDO = list(map(int, getenv("SUDO").split()1769132732 1815707069))
    MONGO_URI = getenv("MONGO_URI", "mongodb+srv://gokreqq:gokreqq@cluster0.pswjgve.mongodb.net/?retryWrites=true&w=majority")
